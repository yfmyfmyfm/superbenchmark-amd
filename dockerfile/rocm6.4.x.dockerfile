...
RUN make RCCL_HOME=/opt/rccl/build/ ROCBLAS_BRANCH=release-staging/rocm-rel-6.4 HIPBLASLT_BRANCH=release-staging/rocm-rel-6.4 ROCM_VER=release/rocm-rel-6.4 -C third_party rocm -o cpu_hpl -o cpu_stream -o megatron_lm
